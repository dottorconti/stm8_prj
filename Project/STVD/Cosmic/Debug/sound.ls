 ...
 173                     ; 43 void soundStone(uint8_t num)
 173                     ; 44 {
 175                     .text:	section	.text,new
 176  0000               _soundStone:
 180                     ; 45 switch (num)
 183                     ; 140 		case 11:  // lineare 970 Hz	
 183                     ; 141 		break;
 184  0000 4d            	tnz	a
 ...
 235                     ; 73 				case 1:
 235                     ; 74 				TIM1_SetCompare4(MUTE);
 237                     ; 75 				songStep = 0;
 238                     ; 76 				break;
 240                     ; 78 		break;
 242  0037               L11:
 243                     ; 80 		case 1:
 243                     ; 81 			switch (songStep)
 ...
 253  003f               L31:
 254                     ; 83 				case 0:
 254                     ; 84 				if (generalLee_song[n]  != MUTE)
 ...
 260                     ; 86 					TIM1_SetAutoreload(generalLee_song[n]);
 262  0047 ee7b          	ldw	x,(_generalLee_song,x)
 263  0049 cd0000        	call	_TIM1_SetAutoreload
 265  004c               L111:
 266                     ; 88 				TIM1_SetCompare4(generalLee_song[n]/duty);
 ...
 278  005e               L311:
 279                     ; 97 				if (generalLee_song[n] == END)
 ...
 323                     ; 127 		case 7:
 323                     ; 128 		break;
 325                     ; 131 		case 8:  // BITONE 1000 - 2000 Hz
 325                     ; 132 		break;
 327                     ; 134 		case 9: // 01001 INTERMITTENT 490Hz 0.5s ON / 1s OFF GENERAL PURPOSE;
 327                     ; 135 		break;
 329                     ; 137 		case 10:  // SWEEP 2800 - 2000  Hz
 329                     ; 138 		break;
 331                     ; 140 		case 11:  // lineare 970 Hz	
 331                     ; 141 		break;
 333  0077               L17:
 334                     ; 143 }
 337  0077 81            	ret	
 ...
 451  0028 81            	ret	
 475                     ; 153 void pausa(void)
 475                     ; 154 {
 476                     .text:	section	.text,new
 477  0000               _pausa:
 481                     ; 155 	TIM1_SetCompare4(0);
 483  0000 5f            	clrw	x
 485                     ; 156 }
